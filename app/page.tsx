    ...
    <div className="min-h-screen bg-dark text-white">
      ...
      <header className="sticky top-0 z-50 bg-dark border-b-4 border-volt/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#waitlist"
              className="brutalist-btn bg-volt text-black text-xs cursor-pointer border-volt"
            >
              Join Beta
            </a>
          </div>
      ...
      <section className="relative overflow-hidden border-b-8 border-black bg-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          ...
          {/* Headline */}
          <h1
            className="font-display uppercase text-[48px] sm:text-[80px] md:text-[120px] lg:text-[150px] leading-[0.85] text-white mb-8"
            style={{
          ...
          {/* Subheadline */}
          <p className="font-body text-xl sm:text-2xl italic text-gray-300 max-w-2xl mb-12">
      ...
      <section className="border-b-8 border-black">
        {/* Section label */}
        <div className="bg-dark px-4 sm:px-6 lg:px-8 py-8 border-b-4 border-black">
          <div className="max-w-7xl mx-auto">
            <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-gray-500 font-bold">
              The problem
            </span>
            <h2 className="font-display text-[40px] sm:text-[60px] md:text-[80px] uppercase leading-[0.85] text-white mt-2">
              Your CRM is{' '}
        ...
        <div className="divide-y-4 divide-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="bg-black p-6 sm:p-8 lg:p-10 border-b-4 md:border-b-0 md:border-r-4 border-black">
              <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-gray-500 font-bold block mb-3">
                The old way
              </span>
              <p className="font-display text-[32px] sm:text-[48px] md:text-[60px] uppercase leading-[0.85] text-white/60">
            ...
            <div className="bg-volt p-6 sm:p-8 lg:p-10">
              <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-black/60 font-bold block mb-3">
                The StreetNotes way
              </span>
              <p className="font-display text-[32px] sm:text-[48px] md:text-[60px] uppercase leading-[0.85] text-black">
                8 calls. Done in 60 seconds.
              </p>
              <p className="font-body text-black/70 mt-4 text-lg">
      ...
      <section className="bg-dark border-b-8 border-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-gray-500 font-bold">
            How it works
          </span>
          <h2 className="font-display text-[40px] sm:text-[60px] md:text-[80px] uppercase leading-[0.85] text-white mt-2 mb-12 sm:mb-16">
            Three steps.
            <br />
            Sixty seconds.{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="relative bg-white border-8 border-black neo-shadow-white p-8 pt-12">
              <div className="absolute -top-4 -left-2 rotate-[-2deg]">
                <span className="bg-volt text-black font-mono text-xs font-bold uppercase tracking-[0.1em] border-4 border-black px-3 py-1">
                  Step 01
                </span>
              </div>
              <div
                className="absolute inset-0 flex items-center justify-center font-display text-[200px] text-black pointer-events-none select-none"
                style={{ opacity: 0.03 }}
              >
                1
              </div>
              <h3 className="font-display text-3xl sm:text-4xl uppercase text-black mb-4 relative">
                Finish your meeting
              </h3>
              <p className="font-body text-black/70 text-lg relative">
            ...
            {/* Step 3 */}
            <div className="relative bg-white border-8 border-black neo-shadow-white p-8 pt-12">
              <div className="absolute -top-4 -left-2 rotate-[-1deg]">
                <span className="bg-volt text-black font-mono text-xs font-bold uppercase tracking-[0.1em] border-4 border-black px-3 py-1">
                  Step 03
                </span>
              </div>
      ...
      {/* ── BENEFITS ── */}
      <section className="bg-white border-b-8 border-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-gray-500 font-bold">
            What changes
          </span>
          <h2 className="font-display text-[40px] sm:text-[60px] md:text-[80px] uppercase leading-[0.85] text-black mt-2 mb-12 sm:mb-16">
            What would you do with 6-8 hours back{' '}
            <span className="text-volt bg-black inline-block px-4">
              every week?
            </span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Benefit 1 */}
            <div className="border-4 border-black p-6 sm:p-8 neo-shadow-sm bg-white cursor-pointer hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-transform duration-100">
              <h3 className="font-display text-2xl sm:text-3xl uppercase text-black mb-3">
                CRM stays full
              </h3>
      ...
      {/* ── CREDIBILITY ── */}
      <section className="bg-black border-b-8 border-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-gray-600 font-bold">
            Why us
          </span>
          <h2 className="font-display text-[40px] sm:text-[60px] md:text-[80px] uppercase leading-[0.85] text-white mt-2 mb-8">
            Built by people who&apos;ve actually{' '}
            <span className="text-volt">successfully carried a quota</span>
          </h2>

          <div className="max-w-3xl">
            <p className="font-body text-xl sm:text-2xl text-gray-300 mb-6">
              We&apos;re not a SaaS team that read about sales in a blog post.
            </p>
            <p className="font-body text-lg text-gray-400 mb-6">
            ...
            <div className="inline-block">
              <span className="sticker rotate-[2deg] font-mono text-sm text-black font-bold uppercase tracking-[0.1em]">
                We fixed that.
              </span>
            </div>
          </div>
      ...
      {/* ── FINAL CTA ── */}
      <section className="bg-volt border-b-8 border-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2
            className="font-display text-[40px] sm:text-[60px] md:text-[80px] lg:text-[100px] uppercase leading-[0.85] text-black mb-4"
            style={{
          ...
          <p className="font-body text-xl sm:text-2xl italic text-black/70 mb-12 max-w-2xl mx-auto">
      ...
      {/* ── FOOTER ── */}
      <footer className="bg-dark border-t-4 border-black py-8">
