...
export function composeRealtimeInstructions(
  ...
  parts.push(
    [
      ...
      '',
      'Step 2 — HELP REQUEST.',
      '  The rep will say something close to: "Great, ' + firstName + ', I was hoping you could help me out for a moment."',
      ...
      '  The rep will ask whether you\'re on the team responsible for your company\'s enterprise video initiatives.',
      '  Answer honestly based on your role as ' + persona.title + ':',
      '    • If YES — confirm briefly. Vary: "Yeah, that\'s my area." / "Yep." / "More or less." / "I own that." / "Part of it, yeah."',
